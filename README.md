...
```mermaid
flowchart LR A[Transaction Generator - generator.py] --> B[TRANSACTIONS_TOPIC] B --> C[Fraud Detector - detector.py] C -->|amount >= 1000| D[FRAUD_TOPIC] C -->|amount < 1000| E[LEGIT_TOPIC]
```
